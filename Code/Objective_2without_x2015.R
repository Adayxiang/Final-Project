...
#logistic regression
library(boot)
glm.fit=glm(trend~has_garage+has_fireplace+ building_count+walkout_basement+air_conditioning+RESIDENTIAL+INDUSTRIAL+MULTI.RES,data=trainData,family="binomial")
coef(glm.fit)
...
#LDA
library(MASS)
lda.fit=lda(trend~has_garage+has_fireplace+ building_count+walkout_basement+air_conditioning+RESIDENTIAL+INDUSTRIAL+MULTI.RES,trainData)
...
#QDA
qda.fit=qda(trend~has_garage+has_fireplace+ building_count+walkout_basement+air_conditioning+RESIDENTIAL+INDUSTRIAL+MULTI.RES,trainData)
